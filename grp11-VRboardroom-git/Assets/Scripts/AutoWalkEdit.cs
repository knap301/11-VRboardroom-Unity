...
// Walk automatically in direction of head movement by either looking down or clicking 
// added walking animation call from AnimController

using UnityEngine;
using System.Collections;

public class AutoWalkEdit : MonoBehaviour
{
	//EDITTED PART
